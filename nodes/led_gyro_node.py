...
TILT_LIMIT_DEG      = 168.0      # Robot is considered safe if tilt is below 60°
ANG_VEL_LIMIT       = 12.0      # Robot is considered safe if angular velocity magnitude is below 10.0 (e.g., rad/s)
